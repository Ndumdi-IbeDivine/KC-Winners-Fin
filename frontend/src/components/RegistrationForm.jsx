...
const RegistrationForm = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-50 p-4">
      <div className="w-full max-w-5xl bg-white shadow-2xl rounded-2xl p-6 sm:p-10">
        ...
        <form onSubmit={handleSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="md:col-span-2">
            <button
              type="submit" 
              disabled={loading} 
              className="w-full bg-blue-600 hover:bg-black text-white font-bold py-3 px-6 rounded mt-4 transition duration-200">
